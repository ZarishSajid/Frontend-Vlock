...
class Test extends React.Component {
  ...
  handleDropdownChange(e) {
    console.log("agent type", e.target.value);
  ...
  onRedirect = (e) => {
    ...
    this.props.form.validateFieldsAndScroll((error, formData) => {
      ...
      if (!error && formData) {
        ...
        axios
          .post(`http://localhost:8080/vlock/voterregister`, {
            ...
            <Card>
              ...
              >
                <h4 style={{ color: "black", fontWeight: "bold" }}>
                  {" "}
                  <center>Registered Voter Information</center>
                </h4>
              </CardHeader>
              <ListGroup flush>
                <ListGroupItem className="p-3">
                  ...
                  <label
                    ...
                    >
                      ...
                      <option style={{ color: "black" }} value="A2">
                      Level 2 Agent

                      </option>
                      <option style={{ color: "black" }} value="A3">
                      Level 3 Agent
